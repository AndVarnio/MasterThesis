...
//    is_WaitForNextImage(hCam, 1000, &(rawImageP), &imageSequenceID);
  ...
  int binOffset = 0;
  // __builtin_prefetch(&rawImageP[rowOffset+binOffset+0]);
...
/*
    ...
    vec1_16x4 = vset_lane_u16((uint16_t)rawImageP[rowAndBinOffset+0], vec1_16x4, 0);
    vec1_16x4 = vset_lane_u16((uint16_t)rawImageP[rowAndBinOffset+1], vec1_16x4, 1);
    vec1_16x4 = vset_lane_u16((uint16_t)rawImageP[rowAndBinOffset+2], vec1_16x4, 2);
    vec1_16x4 = vset_lane_u16((uint16_t)rawImageP[rowAndBinOffset+3], vec1_16x4, 3);


    vec2_16x4 = vset_lane_u16((uint16_t)rawImageP[rowAndBinOffset+4], vec2_16x4, 0);
    vec2_16x4 = vset_lane_u16((uint16_t)rawImageP[rowAndBinOffset+5], vec2_16x4, 1);
    vec2_16x4 = vset_lane_u16((uint16_t)rawImageP[rowAndBinOffset+6], vec2_16x4, 2);
    vec2_16x4 = vset_lane_u16((uint16_t)rawImageP[rowAndBinOffset+7], vec2_16x4, 3);

    vec3_16x4 = vadd_u16(vec1_16x4, vec2_16x4);

    vec1_16x4 = vset_lane_u16((uint16_t)rawImageP[rowAndBinOffset+8], vec1_16x4, 0);
    vec1_16x4 = vset_lane_u16((uint16_t)rawImageP[rowAndBinOffset+9], vec1_16x4, 1);
    vec1_16x4 = vset_lane_u16((uint16_t)rawImageP[rowAndBinOffset+10], vec1_16x4, 2);
    vec1_16x4 = vset_lane_u16((uint16_t)rawImageP[rowAndBinOffset+11], vec1_16x4, 3);


    vec2_16x4 = vset_lane_u16((uint16_t)rawImageP[rowAndBinOffset+12], vec2_16x4, 0);
    vec2_16x4 = vset_lane_u16((uint16_t)rawImageP[rowAndBinOffset+13], vec2_16x4, 1);
    vec2_16x4 = vset_lane_u16((uint16_t)rawImageP[rowAndBinOffset+14], vec2_16x4, 2);
    vec2_16x4 = vset_lane_u16((uint16_t)rawImageP[rowAndBinOffset+15], vec2_16x4, 3);

    vec4_16x4 = vadd_u16(vec1_16x4, vec2_16x4);

    vec1_16x4 = vadd_u16(vec3_16x4, vec4_16x4);

    vec2_16x4 = vset_lane_u16((uint16_t)rawImageP[rowAndBinOffset+16], vec2_16x4, 0);
    vec2_16x4 = vset_lane_u16((uint16_t)rawImageP[rowAndBinOffset+17], vec2_16x4, 1);
    vec2_16x4 = vset_lane_u16((uint16_t)rawImageP[rowAndBinOffset+18], vec2_16x4, 2);
    vec2_16x4 = vset_lane_u16((uint16_t)rawImageP[rowAndBinOffset+19], vec2_16x4, 3);

    vec3_16x4 = vadd_u16(vec1_16x4, vec2_16x4);

    uint16_t totPixVal = vget_lane_u16(vec3_16x4, 0) + vget_lane_u16(vec3_16x4, 1) + vget_lane_u16(vec3_16x4, 2) + vget_lane_u16(vec3_16x4, 3);
    */
    /*
    // uint16_t alane0 = vgetq_lane_u16(vec1_16x8, 0);

    vec2_16x8 = vsetq_lane_u16((uint16_t)rawImageP[rowAndBinOffset+8], vec2_16x8, 0);
    vec2_16x8 = vsetq_lane_u16((uint16_t)rawImageP[rowAndBinOffset+9], vec2_16x8, 1);
    vec2_16x8 = vsetq_lane_u16((uint16_t)rawImageP[rowAndBinOffset+10], vec2_16x8, 2);
    vec2_16x8 = vsetq_lane_u16((uint16_t)rawImageP[rowAndBinOffset+11], vec2_16x8, 3);
    vec2_16x8 = vsetq_lane_u16((uint16_t)rawImageP[rowAndBinOffset+12], vec2_16x8, 4);
    vec2_16x8 = vsetq_lane_u16((uint16_t)rawImageP[rowAndBinOffset+13], vec2_16x8, 5);
    vec2_16x8 = vsetq_lane_u16((uint16_t)rawImageP[rowAndBinOffset+14], vec2_16x8, 6);
    vec2_16x8 = vsetq_lane_u16((uint16_t)rawImageP[rowAndBinOffset+15], vec2_16x8, 7);

    vec3_16x8 = vaddq_u16(vec1_16x8, vec2_16x8);

    // Vector add 6 elements
    uint16_t vec3lane0 = vgetq_lane_u16(vec3_16x8, 0);
    uint16_t vec3lane1 = vgetq_lane_u16(vec3_16x8, 1);

    vec1_16x8 = vsetq_lane_u16(vec3lane0, vec1_16x8, 2);
    vec1_16x8 = vsetq_lane_u16(vec3lane1, vec1_16x8, 3);
    vec1_16x8 = vsetq_lane_u16((uint16_t)rawImageP[rowAndBinOffset+16], vec1_16x8, 4);
    vec1_16x8 = vsetq_lane_u16((uint16_t)rawImageP[rowAndBinOffset+17], vec1_16x8, 5);
    vec1_16x8 = vsetq_lane_u16((uint16_t)rawImageP[rowAndBinOffset+18], vec1_16x8, 6);
    vec1_16x8 = vsetq_lane_u16((uint16_t)rawImageP[rowAndBinOffset+19], vec1_16x8, 7);

    vec2_16x8 = vaddq_u16(vec1_16x8, vec3_16x8);

    // Vector add 3 elements
    uint16x4_t vec1_16x4, vec2_16x4, vec3_16x4;
    vec1_16x4 = vset_lane_u16(vgetq_lane_u16(vec2_16x8, 7), vec1_16x4, 2);
    vec1_16x4 = vset_lane_u16(vgetq_lane_u16(vec2_16x8, 6), vec1_16x4, 1);
    vec1_16x4 = vset_lane_u16(vgetq_lane_u16(vec2_16x8, 5), vec1_16x4, 0);

    vec2_16x4 = vset_lane_u16(vgetq_lane_u16(vec2_16x8, 4), vec2_16x4, 2);
    vec2_16x4 = vset_lane_u16(vgetq_lane_u16(vec2_16x8, 3), vec2_16x4, 1);
    vec2_16x4 = vset_lane_u16(vgetq_lane_u16(vec2_16x8, 2), vec2_16x4, 0);

    vec3_16x4 = vadd_u16(vec1_16x4, vec2_16x4);

    // Add 3 last values together
    uint16_t totPixVal = vget_lane_u16(vec3_16x4, 0) + vget_lane_u16(vec3_16x4, 1) + vget_lane_u16(vec3_16x4, 2);
    */

    uint8x8_t vec1_16x8, vec2_16x8, vec3_16x8;
    // Vector add 8 elements
    // uint16_t d1, d2;
    // uint16x8_t wd = ((uint16_t)d2 << 8) | d1;
    // vec1_16x8 = ((uint16x8_t)rawImageP[rowAndBinOffset+7]<<64) | ((uint16x8_t)rawImageP[rowAndBinOffset+6]<<56) | ((uint16x8_t)rawImageP[rowAndBinOffset+5]<<48) | ((uint16x8_t)rawImageP[rowAndBinOffset+4]<<40) | ((uint16x8_t)rawImageP[rowAndBinOffset+3]<<32) | ((uint16x8_t)rawImageP[rowAndBinOffset+2]<<24) | ((uint16x8_t)rawImageP[rowAndBinOffset+2]<<16) | ((uint16x8_t)rawImageP[rowAndBinOffset+1]<<8) | (uint16x8_t)rawImageP[rowAndBinOffset+0];
  /*	vec1_16x8 = vsetq_lane_u16((uint16_t)rawImageP[rowAndBinOffset+0], vec1_16x8, 0);
  	vec1_16x8 = vsetq_lane_u16((uint16_t)rawImageP[rowAndBinOffset+1], vec1_16x8, 1);
  	vec1_16x8 = vsetq_lane_u16((uint16_t)rawImageP[rowAndBinOffset+2], vec1_16x8, 2);
  	vec1_16x8 = vsetq_lane_u16((uint16_t)rawImageP[rowAndBinOffset+3], vec1_16x8, 3);
  	vec1_16x8 = vsetq_lane_u16((uint16_t)rawImageP[rowAndBinOffset+4], vec1_16x8, 4);
  	vec1_16x8 = vsetq_lane_u16((uint16_t)rawImageP[rowAndBinOffset+5], vec1_16x8, 5);
  	vec1_16x8 = vsetq_lane_u16((uint16_t)rawImageP[rowAndBinOffset+6], vec1_16x8, 6);
  	vec1_16x8 = vsetq_lane_u16((uint16_t)rawImageP[rowAndBinOffset+7], vec1_16x8, 7);
*/
...
/*
  	// Vector add 6 elements
  	uint8_t vec3lane0 = vget_lane_u8(vec3_16x8, 0);
  	uint8_t vec3lane1 = vget_lane_u8(vec3_16x8, 1);

  	vec1_16x8 = vset_lane_u8(vec3lane0, vec1_16x8, 2);
  	vec1_16x8 = vset_lane_u8(vec3lane1, vec1_16x8, 3);
  	vec1_16x8 = vset_lane_u8((uint8_t)rawImageP[rowAndBinOffset+16], vec1_16x8, 4);
  	vec1_16x8 = vset_lane_u8((uint8_t)rawImageP[rowAndBinOffset+17], vec1_16x8, 5);
  	vec1_16x8 = vset_lane_u8((uint8_t)rawImageP[rowAndBinOffset+18], vec1_16x8, 6);
  	vec1_16x8 = vset_lane_u8((uint8_t)rawImageP[rowAndBinOffset+19], vec1_16x8, 7);

  	vec2_16x8 = vadd_u8(vec1_16x8, vec3_16x8);

  	// Vector add 3 elements
  	uint8x8_t vec1_16x4, vec2_16x4, vec3_16x4;
  	vec1_16x4 = vset_lane_u8(vget_lane_u8(vec2_16x8, 7), vec1_16x4, 2);
  	vec1_16x4 = vset_lane_u8(vget_lane_u8(vec2_16x8, 6), vec1_16x4, 1);
  	vec1_16x4 = vset_lane_u8(vget_lane_u8(vec2_16x8, 5), vec1_16x4, 0);

  	vec2_16x4 = vset_lane_u8(vget_lane_u8(vec2_16x8, 4), vec2_16x4, 2);
  	vec2_16x4 = vset_lane_u8(vget_lane_u8(vec2_16x8, 3), vec2_16x4, 1);
  	vec2_16x4 = vset_lane_u8(vget_lane_u8(vec2_16x8, 2), vec2_16x4, 0);

  	vec3_16x4 = vadd_u8(vec1_16x4, vec2_16x4);

  	// Add 3 last values together
  	uint16_t totPixVal = vget_lane_u8(vec3_16x4, 0) + vget_lane_u8(vec3_16x4, 1) + vget_lane_u8(vec3_16x4, 2);
*/
    // int totPixVal = 0;
...
/*
    for(int i=0; i<20; i++){
      totPixVal += (int)rawImageP[rowOffset+binOffset+i];
    }*/
